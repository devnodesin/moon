...
- Never use or reference content from `temp/`, `prd/`, `docs/`, `scripts/md/*` or `example/` for production.
...
- Files in `scripts/md/*` are autogenerated by `scripts/api-check.py`. Never reference or update these files.
